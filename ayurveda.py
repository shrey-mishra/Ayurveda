...
def is_ayurvedic_related(message):
      ayurvedic_keywords = [
      ...
      for keyword in ayurvedic_keywords:
...
def send_message_and_get_response(message):
    ...
    if is_ayurvedic_related(message):
        instructions = "You are Aswini, An ayurvedic doctor. You are chatting with a patient who is seeking advice on their ayurvedic doshas, Everytime the session is exited you have to start a fresh conversation with the patient"
